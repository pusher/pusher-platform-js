...
var WebSocketTransport = (function () {
    ...
    WebSocketTransport.prototype.connect = function () {
        ...
        this.socket.onclose = function (event) {
            ...
            _this.logger.warn("111111111");
            _this.logger.warn(allSubscriptions);
            _this.logger.warn("222222222");
            _this.logger.warn(_this.subscriptions);
            _this.logger.warn("333333333");
            _this.logger.warn(_this.pendingSubscriptions);
            _this.logger.warn("444444444");
            _this.subscriptions.removeAll();
            _this.pendingSubscriptions.removeAll();
            debugger;
            _this.logger.warn("555555555");
            _this.logger.warn(allSubscriptions);
            _this.logger.warn("666666666");
            _this.logger.warn(_this.subscriptions);
            _this.logger.warn("777777777");
            _this.logger.warn(_this.pendingSubscriptions);
            _this.logger.warn("888888888");
