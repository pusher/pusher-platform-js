...
var WebSocketTransport = (function () {
    ...
    WebSocketTransport.prototype.connect = function () {
        ...
        this.socket.onclose = function (event) {
            self.console.log("At the top of onclose");
            self.console.log("Trace start");
            self.console.trace();
            self.console.log("Trace end");
            self.console.log("Event in onclose");
            self.console.log(event);
            self.console.log("Is there a closedError?");
            self.console.log(_this.closedError);
            self.console.log("About to call tryReconnectIfNeeded");
            _this.tryReconnectIfNeeded();
        };
    };
    WebSocketTransport.prototype.close = function (error) {
        self.console.log("At the top of close()");
    ...
    WebSocketTransport.prototype.tryReconnectIfNeeded = function () {
        ...
        self.console.log("this.socket.readyState: " + this.socket.readyState);
        self.console.log("this.forcedClose: " + this.forcedClose);
