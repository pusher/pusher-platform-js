...
class RetryStrategyImpl implements RetryStrategy {
    ...
    executeSubscription(
        ...
        resolveError(error: any): Promise<any>{
            return new Promise( (resolve, reject) => {
                ...
                //Retry logic and timeouts and all that shebang go here.
            });
        }
    }
    ...
    export class BaseSubscriptionConstructionImpl implements BaseSubscriptionConstruction {
        ...
        constructor(
            ...
            tokenProvider: TokenProvider,
            xhr: XMLHttpRequest //XHR comes batteries included, we do not care about any additional params here. So does the token provider. We just do what we're told.
        ){
